const level1 = new Level(
  ...
  [
    ...
    new Cloud("img/5_background/layers/4_clouds/1.png", 250),
    new Cloud("img/5_background/layers/4_clouds/1.png", 100),
    new Cloud("img/5_background/layers/4_clouds/1.png", 710),
    new Cloud("img/5_background/layers/4_clouds/1.png", 800),
    new Cloud("img/5_background/layers/4_clouds/1.png", 942),
    new Cloud("img/5_background/layers/4_clouds/1.png", 1000),
    new Cloud("img/5_background/layers/4_clouds/1.png", 1240),
